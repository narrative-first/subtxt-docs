...
- **Main Character** (I)
- **Catalyst Provocateur** (You)
- **Relationship Story** (We, usually the relationship between the Main and Catalyst Provocateur)

The Objective and Relationship Stories must contrast in conflict type (External Framing vs. Internal Framing, External Processing vs. Internal Processing), as should the Main and Catalyst Provocateurs. This opposition maximizes conflict in the narrative.
