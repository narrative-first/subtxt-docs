...
icon: i-heroicons-film
---
In _A Christmas Carol_, Scrooge\'s MC Throughline is in Mind. It is not enough then to just illustrate this Domain of Mind as "having a bad attitude." To effectively illustrate his MC Throughline in Mind, one must show how his "having a bad attitude" is a source of conflict for him personally and creating conflict in and around him.
::
...
The second most important concept to understand (just right behind the idea that [Subject Matter is not Conflict](/key-concepts-subject-matter-is-not-conflict)) is the focus on *the Source of Conflict*. 
...
![](https://res.cloudinary.com/narrative-first/image/upload/v1694123590/documentation/understanding-why-obtaining-is-a-problem.png)
...
![](https://res.cloudinary.com/narrative-first/image/upload/v1694123649/documentation/illustrating-the-source-of-conflict-with-several-ideas.png)
...
![](https://res.cloudinary.com/narrative-first/image/upload/v1694124108/documentation/illustrating-another-idea-for-a-source-of-conflict.png)
...
The Objective and Relationship Stories must contrast in conflict type (Universe vs. Mind, Physics vs. Psychology), as should the Main and Obstacle Characters. This opposition maximizes conflict in the narrative.
