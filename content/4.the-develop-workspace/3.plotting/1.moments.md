...
#### Narrative Agents & Weaving (Pro & Infinite Subscribers)  

Pro and Infinite subscribers can now leverage Subtxt's Narrative Agents to weave the Storybeats of a Moment. Simply add all the Storybeats you want to see play out in a Moment—regardless of order—then tap **Weave**. After confirming, Subtxt will analyze the Moment, its setting, and all the included Storybeats to determine the best way to weave through them. It maintains the order of individual Throughlines while ensuring logical and emotional progression (with a touch of surprise).  

Once processing is complete, you'll receive an email notification. Returning to Subtxt, you'll find a new **Synopsis** button, which provides a wrap-up of the ordered Storybeats below. This synopsis is not editable, serving as an overview of the structured narrative.  

You can then review the Storybeats as arranged by the Narrative Agents and move any you’d like to reposition. If you do make changes, be sure to re-generate the Synopsis to reflect the updated order. Otherwise, you can proceed to the next Moment and continue the process.
