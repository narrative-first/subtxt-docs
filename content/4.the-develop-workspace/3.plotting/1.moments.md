...
### Moment Actions: Setup, Synopsis, and Weave

Every Moment in Subtxt provides three key actions to help structure your story:

- **Setup**: Define the setting, characters, or any other key elements of the Moment. Subtxt will incorporate these details when weaving the Storybeats and generating the Synopsis.
...
With Subtxt’s Narrative Agents, structuring isn’t something you have to wrestle with anymore. Focus on capturing the right Storybeats, and let Subtxt take care of the rest.
