...
If you're writing a screenplay, you likely won't need to breakdown the Transits for the Catalyst Provocateur or the Relationship Story Throughlines. In fact, we strongly suggest you don't.
...
Subtxt maintains an active and evolving database of Illustrations aligned with the Universal Narrative Model. What you see here in the dropdown is just a short window into the tens of thousands of Illustrations available to every Method.
