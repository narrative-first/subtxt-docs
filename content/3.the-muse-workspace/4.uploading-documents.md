...
---
Due to limitations with our third-party AI provider, **file uploads are only available in Flow Mode**. If you need to reference an external document while using Focus Mode, consider pasting relevant excerpts directly into your request. This limitation applies to Theory mode as well.
::
