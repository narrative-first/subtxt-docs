...
Feeling stuck or uncertain? The **What's Next?** feature is here to help. It reviews your current conversation and, if you're working within a story or Storyform context, it checks which Narrative Aspects you've developed so far. Based on this analysis, Muse identifies the next steps to keep your story moving forward. In a Storyform context, What's Next? dives even deeper, offering detailed suggestions that are specifically tailored to fill any gaps in your narrative (highly recommended).
...
- **Storyforming Mode**: A guided path to building and refining a **Storyform**, ensuring your story's structure and thematic argument are solid. *(Available to **Subtxt Infinite** subscribers only.)*

::callout
---
icon: i-heroicons-exclamation-triangle
---
Full access to Muse's complete suite of tools—including image generation, finalizing storyforms, and advanced narrative exploration—is exclusive to **Muse Mode**. Ensure you're in Muse Mode to unlock these powerful features. 
::
