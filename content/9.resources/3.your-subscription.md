...
| **Tier**          | **Focus & Flow**                       | **Memory Constraints**       | **Key Features**                                                                                 
|--------------------|----------------------------------------|------------------------------|-------------------------------------------------------------------------------------------------------|
| **Subtxt**         | Flow-Centric Creation with occasional Focus checks | Minimal <br> *Scaling back under excessive usage                     | - 32,000+ Unique Narrative Structures  <br> - Occasional Focus checks for basic consistency  <br> - 2GB document storage <br> - Single Customizable Muse Persona |
| **Subtxt Pro**     | Switch between Flow & Focus seamlessly | Moderate                     | - 32,000+ Unique Narrative Structures  <br> - Adapt mode to each stage of writing  <br> - HD Voice Response & Image Generation  <br> - 2x Memory Context of Subtxt  <br> - 5GB document storage  <br> - Multiple Customizable Muse Personas (Story-Specific) |
| **Subtxt Infinite**| Unlimited Advanced Focus with Flow support | Maximum                      | - 32,000+ Unique Narrative Structures  <br> - Handle extensive logic & massive story scope  <br> - HD Voice Response & Image Generation  <br> - Maximum Memory Context  <br> - Multiple doc uploads per conversation  <br> - 10GB document storage  <br> - Story-Specific Uploads (Worldbuilding)  <br> - Multiple Customizable Muse Personas (Story-Specific) |
