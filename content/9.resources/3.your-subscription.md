...
|--------------------|-----------------------------------------|-----------------------------------------|-----------------------------------------------------------------------------------------------------|
| **Subtxt**        | Flow-centric with occasional Focus checks | Minimal (scales back under heavy use), 2GB storage | 32,000+ unique narrative structures, single customizable Muse Persona. One Narrative Agent (Generate Four Throughlines)                             |
| **Subtxt Pro**    | Switch seamlessly between Flow & Focus    | Moderate, 2x memory of Subtxt, 5GB storage | HD voice & image generation, multiple customizable Muse Personas (story-specific). Access to ALL Narrative Agents.                  |
